...
hl("@keywordFunction", colors.base15, colors.none, italic)
hl("@keywordOperator", colors.base15, colors.none)
hl("@keywordReturn", colors.base15, colors.none)
hl("@label", colors.base15, colors.none)
...
hl("@tag", colors.base10, colors.none)
hl("@tagAttribute", colors.base13, colors.none)
hl("@tagDelimiter", colors.base3, colors.none)
