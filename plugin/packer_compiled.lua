...
_G.packer_plugins = {
  LuaSnip = {
    ...
    loaded = true,
    path = "/home/jonty/.local/share/nvim/site/pack/packer/start/LuaSnip",
  ...
  ["cmp-latex-symbols"] = {
    ...
    url = "https://github.com/jc-doyle/cmp-latex-symbols"
  },
  ["cmp-nvim-lsp"] = {
    loaded = true,
  ...
  cmp_luasnip = {
    loaded = true,
    path = "/home/jonty/.local/share/nvim/site/pack/packer/start/cmp_luasnip",
  ...
  ["gitsigns.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/jonty/.local/share/nvim/site/pack/packer/opt/gitsigns.nvim",
...
try_loadstring("\27LJ\2\n8\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\29plugin-settings.snippets\frequire\0", "config", "LuaSnip")
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-comment', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
