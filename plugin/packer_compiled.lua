...
_G.packer_plugins = {
  ...
  ["galaxyline.nvim"] = {
    ...
    loaded = true,
    path = "/home/jonty/.local/share/nvim/site/pack/packer/start/galaxyline.nvim"
  },
  kommentary = {
    loaded = true,
  ...
  ["lspsaga.nvim"] = {
    loaded = true,
    path = "/home/jonty/.local/share/nvim/site/pack/packer/start/lspsaga.nvim"
  },
  ["neoscroll.nvim"] = {
...
try_loadstring("\27LJ\1\2:\0\0\2\0\2\0\0044\0\0\0%\1\1\0>\0\2\1G\0\1\0\31plugin-settings/statusline\frequire\0", "config", "galaxyline.nvim")
