...
_G.packer_plugins = {
  ...
  ["nvim-toggleterm.lua"] = {
    config = { "\27LJ\1\0028\0\0\2\0\2\0\0044\0\0\0%\1\1\0>\0\2\1G\0\1\0\29plugin-settings.terminal\frequire\0" },
    loaded = false,
    needs_bufread = false,
    path = "/home/jonty/.local/share/nvim/site/pack/packer/opt/nvim-toggleterm.lua"
  },
  ["nvim-tree.lua"] = {
